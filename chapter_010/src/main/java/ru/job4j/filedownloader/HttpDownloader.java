 ...
 * wget (ссылка) (скорость в килобайтах в секунду) для того, чтобы ограничить скорость скачивания,
 * нужно проверять сколько загрузиться за 1 секунду, если объем больше, то нужно выставлять паузу.
