...
public class SqlRuParser {
     ...
     * и не содержит "javascript", "java script", отсутствует ли метка "закрыт".
     *
    ...
    /**
     * Конвертирует дату публикации из строки в дату формата "dd MM yy, HH:mm".
     *
    ...
    public Date convertOfDate(String stringDate) {
        Date date = null;
        String[] givenMonths = {"янв", "фев", "мар", "апр", "май", "июн", "июл", "авг", "сен", "окт", "ноя", "дек"};
        String[] realMonths = {"01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"};
