...
public class Max {
    /**
     * Метод возвращается максимальное значение из 2-х чисел.
     *
    ...
    /**
     * Метод возвращается максимальное значение из 3-х чисел.
     *
     * @param first  первое значение для сравнения.
     * @param second второе значение для сравнения.
    ...
    /**
     * Метод возвращается максимальное значение из 4-х чисел.
     *
     * @param first  первое значение для сравнения.
     * @param second второе значение для сравнения.
     * @param third  третье значение для сравнения.
