...
public class LogicTest {
    ...
    /**
     * Test move right up QueenBlack.
     */
    @Test
    public void whenQueenBlackMoveRightUpThenTrue() {
        Logic logic = new Logic();
        logic.add(new QueenBlack(Cell.E8));
     ...
     */
    @Test
    public void whenQueenBlackWayThenCellSteps() {
        QueenBlack queenBlack = new QueenBlack(Cell.E8);
        Cell[] result = queenBlack.way(Cell.E8, Cell.E5);
